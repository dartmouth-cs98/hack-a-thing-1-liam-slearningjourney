 ...
 */
// 1
var characterName: String = "Liam", weaponClassification: String = "Banana"

// 2
characterName += " 'Known fun guy' Jolley"

// 3
var currentMana: Double = 64.0
...
// 5
var debugStats: String = "Name: \(characterName) \nMana: \(currentMana)\nMana Percentage: \(manaPercentage)"

// 6
var questAccepted: Bool = true, canQuest: Bool = true
