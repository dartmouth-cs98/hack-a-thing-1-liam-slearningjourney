 ...
 */
// 1
var shopItemsArray: [String] = ["apples", "bananas", "peaches", "berries"]
var shopItemsDictionary: [String : Double] = ["apples" : 0.98, "bananas" : 0.54, "peaches" : 1.76, "berries" : 4.32]

// 2
shopItemsArray.contains("mangoes")

// 3
shopItemsArray.insert("mangoes", at: 4)

// 4
var selectedItem: String = shopItemsArray[1]

// 5
var selectedItemPrice = shopItemsDictionary[selectedItem]

// 6
var fullArmorSet: Set = ["sword", "knife", "plate"]
var currentArmorSet: Set = ["knife", "plate"]

// 7
fullArmorSet.subtract(currentArmorSet)

// 8
var armorPieceTuple = (name: "sword", cost: 2400, canEquip: false)
